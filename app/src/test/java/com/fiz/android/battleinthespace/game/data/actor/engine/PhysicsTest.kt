...
class PhysicsTest {
    ...
    fun overlap2RectangleIntersectionBorderNoOverlap() {
        assertFalse(Physics.overlap(Vec(0.5, 9.5), 3.0, Vec(width, 5.0), 3.0))
    }

    @Test
    fun overlap2RectangleIntersectionBorderYesOverlap() {
        assertTrue(Physics.overlap(Vec(0.5, 9.5), 3.0, Vec(width, 7.5), 3.0))
    }
    ...
    fun overlapRectangle2RectangleIntersectionBorderNoOverlap() {
        assertFalse(Physics.overlapRectangle(Vec(0.5, 9.5), 3.0, Vec(width, 5.0), 3.0))
    }

    @Test
    fun overlapRectangle2RectangleIntersectionBorderYesOverlap() {
        assertTrue(Physics.overlapRectangle(Vec(0.5, 9.5), 3.0, Vec(width, 7.5), 3.0))
    }
    ...
    fun overlapCircle2CircleIntersectionBorderNoOverlap() {
        assertFalse(Physics.overlapCircle(Vec(0.5, 9.5), 3.0, Vec(width, 5.0), 3.0))
    }

    @Test
    fun overlapCircle2CircleIntersectionBorderYesOverlap() {
        assertTrue(Physics.overlapCircle(Vec(0.5, 9.5), 3.0, Vec(width, 7.5), 3.0))
    }
