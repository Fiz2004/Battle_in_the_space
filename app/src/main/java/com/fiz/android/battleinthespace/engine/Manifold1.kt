...
//
//class Manifold1(var A: Body, var B: Body) {
...
//            val ra: Vec2 = contacts[i] - A.center
//            val rb: Vec2 = contacts[i] - B.center
//
//            val rv: Vec2 = B.speed + Cross(B.angleSpeed, rb) - A.speed - Cross(
//                A.angleSpeed,
//                ra
//            );
//
...
//            var rv: Vec2 = B.speed + Cross(B.angleSpeed, rb) - A.speed - Cross(
//                A.angleSpeed,
//                ra
//            )
//
