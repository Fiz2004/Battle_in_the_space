...
//    val circle1: Circle = a as Circle
//    val circle2: Circle = b as Circle
//
//    // Вычислить вектор поступательного движения, который является нормальным
//    val normal: Vec2 = b.center - a.center
//
//    val distSqr: Double = normal.LenSqr()
//    val radius: Double = circle1.radius + circle2.radius
//
//    // Не в контакте
...
//    var center: Vec2 = a.center
//    center = B.u.Transpose() * (center - b.center)
//
...
//        m.contacts[0] = m.normal * A.radius + a.center
...
//    v[0] = IncPoly.u * IncPoly.m_vertices[incidentFace] + IncPoly.body.center
//    incidentFace = if (incidentFace + 1 >= IncPoly.m_vertexCount) 0 else incidentFace + 1
//    v[1] = IncPoly.u * IncPoly.m_vertices[incidentFace] + IncPoly.body.center
//}
//
...
//    v1 = RefPoly.u * v1 + RefPoly.body.center
//    v2 = RefPoly.u * v2 + RefPoly.body.center
//
