...
class Display(
  ...
  private val bmpBulletDestroy: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.bullet_destroy)
  ...
  private val bmpSpaceshipDestroy: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.spaceship_destroy)
  ...
  private fun initBmpBackground():Array<Bitmap> {
    ...
    for (i in 1..NUMBER_BITMAP_BACKGROUND)
      result+= BitmapFactory.decodeResource(resources, resources.getIdentifier("background$i",
  ...
  private fun initBmpMeteorite():Array<Array<Bitmap>> {
    ...
    for (i in 0 until NUMBER_BITMAP_METEORITE_OPTION)
      ...
      result+= BitmapFactory.decodeResource(resources, resources.getIdentifier("meteorite$i$j",
        "drawable", context.packageName))
    return result
  }
  ...
  private fun initBmpSpaceship():Array<Bitmap> {
    ...
    for (i in 1..NUMBER_BITMAP_SPACESHIP)
        result+= BitmapFactory.decodeResource(resources, resources.getIdentifier("spaceship$i",
          "drawable", context.packageName))
    return result
  }
  ...
  private fun initBmpSpaceshipLife():Array<Bitmap> {
    ...
    for (i in 1..NUMBER_BITMAP_SPACESHIP_LIFE)
      result+= BitmapFactory.decodeResource(resources, resources.getIdentifier("spaceship_life$i",
        "drawable", context.packageName))
    return result
  }
