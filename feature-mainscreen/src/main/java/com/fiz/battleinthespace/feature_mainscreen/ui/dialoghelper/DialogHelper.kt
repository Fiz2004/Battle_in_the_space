...
class DialogHelper : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialogState =
            requireArguments().parcelable(KEY, DialogState::class.java)
    ...
    private fun setOnClickSignUpIn(
        ...
        when (dialogState) {
            DialogState.SignUp -> accountViewModel.signUpWithEmail(email, password)
            DialogState.SignIn -> accountViewModel.signInWithEmail(email, password)
        }
    }
